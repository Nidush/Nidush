      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            <Ionicons name="notifications" size={26} color="#4A6741" />
        ...
        <View style={styles.activeCard}>
          ...
          <TouchableOpacity style={styles.playButton}>
            <Ionicons name="play" size={28} color="#4A6741" />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.horizontalScroll}>
          ...
          <ActivityCard title="Pikelets" time="17min" room="Kitchen" image="https://images.unsplash.com/photo-1552196563-55cd4e45efb3?q=80&w=400" />
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  activeInfo: { flex: 1 },
  activeLabel: { color: 'white', fontSize: 14, opacity: 0.8, fontFamily: 'Nunito_400Regular' },
  activeTitle: { 
    color: 'white', 
    fontSize: 24, 
    fontWeight: 'bold', 
  ...
  miniIconCircle: { backgroundColor: 'rgba(255,255,255,0.2)', padding: 6, borderRadius: 50 },
  ...
  editLink: { color: '#4A6741', textDecorationLine: 'underline', fontFamily: 'Nunito_600SemiBold' },
