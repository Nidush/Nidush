    ...
    <View className="mb-5 overflow-hidden rounded-[25px] bg-white shadow-sm border border-gray-100">
      ...
      >
        ...
        <View className="flex-1 pr-4">
          <Text className="text-white text-[22px] mb-3" style={{ fontFamily: 'Nunito_700Bold' }}>
            {title}
          </Text>
          ...
          <View className="gap-y-1">
            <View className="flex-row items-center">
              ...
              <Text className="text-white/90 ml-2 text-[13px]" style={{ fontFamily: 'Nunito_600SemiBold' }}>{days}</Text>
            </View>
            <View className="flex-row items-center">
              <Feather name="clock" size={14} color="white" />
              <Text className="text-white/90 ml-2 text-[13px]" style={{ fontFamily: 'Nunito_600SemiBold' }}>{time}</Text>
            </View>
            <View className="flex-row items-center">
              <MaterialIcons name="door-front" size={14} color="white" />
              <Text className="text-white/90 ml-2 text-[13px]" style={{ fontFamily: 'Nunito_600SemiBold' }}>{room}</Text>
            </View>
          </View>
        </View>
        ...
        >
          <View className={`w-5 h-5 bg-white rounded-full shadow-sm ${isActive ? 'self-end' : 'self-start'}`} />
        </TouchableOpacity>
      </ImageBackground>
    </View>
  );
