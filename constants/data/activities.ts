...
export const ACTIVITIES: Activity[] = [
  ...
  },
  {
    ...
    contentId: 'c9',
    scenarioId: 's1',
    keywords: ['morning', 'energy', 'meditation', 'sunrise', 'flow'],
  },
  {
    id: '3',
    ...
    contentId: 'c2',
    scenarioId: 's5',
    keywords: ['morning', 'gratitude', 'zen', 'start', 'meditation', 'flow'],
  },
  {
    id: '4',
    title: 'Brownies',
  ...
  },
  {
    ...
    type: 'meditation',
    contentId: 'c2',
    keywords: ['morning', 'zen', 'meditation', 'start', 'energy', 'quick'],
  },
  {
    id: '6',
    title: 'Eggs Benedict',
    ...
    contentId: 'c10',
    scenarioId: 's4',
    keywords: ['morning', 'breakfast', 'brunch', 'weekend'],
  },
  {
    id: '7',
    title: 'Vodka Pasta',
    ...
    type: 'cooking',
    keywords: ['evening', 'dinner', 'pasta', 'comfort', 'party', 'cooking'],
  },
  {
    id: '8',
    title: 'Evening Read',
